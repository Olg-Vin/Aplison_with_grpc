...
@javax.annotation.Generated(
    ...
    comments = "Source: client_grpc.proto")
@io.grpc.stub.annotations.GrpcGenerated
public final class MessageServiceGrpc {

  private MessageServiceGrpc() {}

  public static final java.lang.String SERVICE_NAME = "com.example.grpc.MessageService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.example.grpc.MessageServiceProto.RequestMessage,
      com.example.grpc.MessageServiceProto.ResponseMessage> getSendMessageMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "SendMessage",
      requestType = com.example.grpc.MessageServiceProto.RequestMessage.class,
      responseType = com.example.grpc.MessageServiceProto.ResponseMessage.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.example.grpc.MessageServiceProto.RequestMessage,
      com.example.grpc.MessageServiceProto.ResponseMessage> getSendMessageMethod() {
    io.grpc.MethodDescriptor<com.example.grpc.MessageServiceProto.RequestMessage, com.example.grpc.MessageServiceProto.ResponseMessage> getSendMessageMethod;
      ...
      synchronized (MessageServiceGrpc.class) {
        if ((getSendMessageMethod = MessageServiceGrpc.getSendMessageMethod) == null) {
          MessageServiceGrpc.getSendMessageMethod = getSendMessageMethod =
              io.grpc.MethodDescriptor.<com.example.grpc.MessageServiceProto.RequestMessage, com.example.grpc.MessageServiceProto.ResponseMessage>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "SendMessage"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.example.grpc.MessageServiceProto.RequestMessage.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.example.grpc.MessageServiceProto.ResponseMessage.getDefaultInstance()))
  ...
  public interface AsyncService {
    ...
    /**
     */
    default void sendMessage(com.example.grpc.MessageServiceProto.RequestMessage request,
        io.grpc.stub.StreamObserver<com.example.grpc.MessageServiceProto.ResponseMessage> responseObserver) {
  ...
  public static final class MessageServiceStub
    ...
    /**
     */
    public void sendMessage(com.example.grpc.MessageServiceProto.RequestMessage request,
        io.grpc.stub.StreamObserver<com.example.grpc.MessageServiceProto.ResponseMessage> responseObserver) {
  ...
  public static final class MessageServiceBlockingStub
    ...
    /**
     */
    public com.example.grpc.MessageServiceProto.ResponseMessage sendMessage(com.example.grpc.MessageServiceProto.RequestMessage request) {
  ...
  public static final class MessageServiceFutureStub
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.example.grpc.MessageServiceProto.ResponseMessage> sendMessage(
        com.example.grpc.MessageServiceProto.RequestMessage request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_SEND_MESSAGE:
          serviceImpl.sendMessage((com.example.grpc.MessageServiceProto.RequestMessage) request,
              (io.grpc.stub.StreamObserver<com.example.grpc.MessageServiceProto.ResponseMessage>) responseObserver);
          break;
        default:
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              com.example.grpc.MessageServiceProto.RequestMessage,
              com.example.grpc.MessageServiceProto.ResponseMessage>(
  ...
  private static abstract class MessageServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.example.grpc.MessageServiceProto.getDescriptor();
    }
